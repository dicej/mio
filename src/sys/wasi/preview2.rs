    ...
    pub mod exit {
      ...
      pub fn exit(status: Result<(),()>,){
        ...
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/exit@0.2.0-rc-2023-12-05")]
          extern "C" {
            #[link_name = "exit"]
            fn wit_import(_: i32, );
          }
    ...
    pub mod stdin {
      ...
      pub fn get_stdin() -> InputStream{
        ...
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/stdin@0.2.0-rc-2023-12-05")]
          extern "C" {
            #[link_name = "get-stdin"]
            fn wit_import() -> i32;
          }
    ...
    pub mod stdout {
      ...
      pub fn get_stdout() -> OutputStream{
        ...
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/stdout@0.2.0-rc-2023-12-05")]
          extern "C" {
    ...
    pub mod stderr {
      ...
      pub fn get_stderr() -> OutputStream{
        ...
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/stderr@0.2.0-rc-2023-12-05")]
          extern "C" {
    ...
    pub mod terminal_input {
      ...
      unsafe impl wit_bindgen::rt::WasmResource for TerminalInput{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          {
            #[link(wasm_import_module = "wasi:cli/terminal-input@0.2.0-rc-2023-12-05")]
            extern "C" {
    ...
    pub mod terminal_output {
      ...
      unsafe impl wit_bindgen::rt::WasmResource for TerminalOutput{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          {
            #[link(wasm_import_module = "wasi:cli/terminal-output@0.2.0-rc-2023-12-05")]
            extern "C" {
    ...
    pub mod terminal_stdin {
      ...
      pub fn get_terminal_stdin() -> Option<TerminalInput>{
        ...
        unsafe {
          ...
          let ptr0 = ret_area.as_mut_ptr() as i32;
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-stdin@0.2.0-rc-2023-12-05")]
          extern "C" {
    ...
    pub mod terminal_stdout {
      ...
      pub fn get_terminal_stdout() -> Option<TerminalOutput>{
        ...
        unsafe {
          ...
          let ptr0 = ret_area.as_mut_ptr() as i32;
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-stdout@0.2.0-rc-2023-12-05")]
          extern "C" {
    ...
    pub mod terminal_stderr {
      ...
      pub fn get_terminal_stderr() -> Option<TerminalOutput>{
        ...
        unsafe {
          ...
          let ptr0 = ret_area.as_mut_ptr() as i32;
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-stderr@0.2.0-rc-2023-12-05")]
          extern "C" {
    ...
    pub mod wall_clock {
      ...
      pub fn now() -> Datetime{
        ...
        unsafe {
          ...
          let ptr0 = ret_area.as_mut_ptr() as i32;
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:clocks/wall-clock@0.2.0-rc-2023-11-10")]
          extern "C" {
            #[link_name = "now"]
            fn wit_import(_: i32, );
          }
    ...
    pub mod types {
      ...
      unsafe impl wit_bindgen::rt::WasmResource for Descriptor{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          {
            #[link(wasm_import_module = "wasi:filesystem/types@0.2.0-rc-2023-11-10")]
            extern "C" {
        ...
        pub mod random {
          ...
          pub fn get_random_bytes(len: u64,) -> wit_bindgen::rt::vec::Vec::<u8>{
            ...
            unsafe {
              ...
              let ptr0 = ret_area.as_mut_ptr() as i32;
              #[cfg(target_arch = "wasm32")]
              #[link(wasm_import_module = "wasi:random/random@0.2.0-rc-2023-11-10")]
              extern "C" {
        ...
        pub mod insecure {
          ...
          pub fn get_insecure_random_bytes(len: u64,) -> wit_bindgen::rt::vec::Vec::<u8>{
            ...
            unsafe {
              ...
              let ptr0 = ret_area.as_mut_ptr() as i32;
              #[cfg(target_arch = "wasm32")]
              #[link(wasm_import_module = "wasi:random/insecure@0.2.0-rc-2023-11-10")]
              extern "C" {
        ...
        pub mod insecure_seed {
          ...
          pub fn insecure_seed() -> (u64,u64,){
            ...
            unsafe {
              ...
              let ptr0 = ret_area.as_mut_ptr() as i32;
              #[cfg(target_arch = "wasm32")]
              #[link(wasm_import_module = "wasi:random/insecure-seed@0.2.0-rc-2023-11-10")]
              extern "C" {
        ...
        pub mod network {
          ...
          unsafe impl wit_bindgen::rt::WasmResource for Network{
            ...
            unsafe fn drop(_handle: u32) {
              ...
              #[cfg(target_arch = "wasm32")]
              {
                #[link(wasm_import_module = "wasi:sockets/network@0.2.0-rc-2023-11-10")]
                extern "C" {
        ...
        pub mod instance_network {
          ...
          pub fn instance_network() -> Network{
            ...
            unsafe {
              ...
              #[cfg(target_arch = "wasm32")]
              #[link(wasm_import_module = "wasi:sockets/instance-network@0.2.0-rc-2023-11-10")]
              extern "C" {
        ...
        pub mod udp {
          ...
          unsafe impl wit_bindgen::rt::WasmResource for UdpSocket{
            ...
            unsafe fn drop(_handle: u32) {
              ...
              #[cfg(target_arch = "wasm32")]
              {
                #[link(wasm_import_module = "wasi:sockets/udp@0.2.0-rc-2023-11-10")]
                extern "C" {
              ...
              pub mod udp_create_socket {
                ...
                pub fn create_udp_socket(address_family: IpAddressFamily,) -> Result<UdpSocket,ErrorCode>{
                  ...
                  unsafe {
                    ...
                    let ptr0 = ret_area.as_mut_ptr() as i32;
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:sockets/udp-create-socket@0.2.0-rc-2023-11-10")]
                    extern "C" {
              ...
              pub mod tcp {
                ...
                unsafe impl wit_bindgen::rt::WasmResource for TcpSocket{
                  ...
                  unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                      #[link(wasm_import_module = "wasi:sockets/tcp@0.2.0-rc-2023-11-10")]
                      extern "C" {
              ...
              pub mod tcp_create_socket {
                ...
                pub fn create_tcp_socket(address_family: IpAddressFamily,) -> Result<TcpSocket,ErrorCode>{
                  ...
                  unsafe {
                    ...
                    let ptr0 = ret_area.as_mut_ptr() as i32;
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:sockets/tcp-create-socket@0.2.0-rc-2023-11-10")]
                    extern "C" {
              ...
              pub mod ip_name_lookup {
                ...
                unsafe impl wit_bindgen::rt::WasmResource for ResolveAddressStream{
                  ...
                  unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                      #[link(wasm_import_module = "wasi:sockets/ip-name-lookup@0.2.0-rc-2023-11-10")]
                      extern "C" {
